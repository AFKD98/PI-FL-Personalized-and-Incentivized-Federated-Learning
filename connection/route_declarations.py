...
def get_aggregator_router(router, agg_proto_handler):
    ...
    router.add_routes({
        ...
        '{}'.format(MessageType.REQUEST_TIER_PREFERENCES.value):
        agg_proto_handler.process_tier_preference_requests,
        
        '{}'.format(MessageType.REQUEST_PERSONALIZED_ACC.value):
        agg_proto_handler.process_personalized_model_requests,
...
def get_party_router(router, party_proto_handler):
    ...
    router.add_routes({
        ...
        '{}'.format(MessageType.TRAIN_BY_TIER.value): party_proto_handler.handle_async_request,
        '{}'.format(MessageType.SAVE_MODEL_BY_TIER.value): party_proto_handler.handle_request,
        '{}'.format(MessageType.EVAL_MODEL_BY_TIER.value): party_proto_handler.handle_request,
        '{}'.format(MessageType.SYNC_MODEL_BY_TIER.value): party_proto_handler.handle_request,
        '{}'.format(MessageType.REQUEST_TIER_PREFERENCES.value): party_proto_handler.handle_async_request,
        '{}'.format(MessageType.REQUEST_PERSONALIZED_ACC.value): party_proto_handler.handle_async_request,
        '{}'.format(MessageType.REQUEST_AVG_ACC.value): party_proto_handler.handle_request,
        'default': default_end_point
    })
